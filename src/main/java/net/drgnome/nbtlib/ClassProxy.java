...
public class ClassProxy
{
    ...
    /**
     * <p>Returns {@code true} if the given Class object is a proxy class generated by the ClassProxy class.</p>
     *
     * @param clazz The Class object to be checked.
     *
     * @return {@code true} if the given Class object is a proxy class, {@code false} otherwise.
     */
     ...
     *
     * @return The new class. May be null if {@code createIfNotExists == false}.
     *
    ...
    private static synchronized Class defineClass(Class superClass, Method[] mthd) throws ClassFormatError, IllegalAccessException, NoSuchMethodException, VerifyError
    {
        ...
        try
        {
            return (Class)m.invoke(ClassProxy.class.getClassLoader(), className, b, 0, b.length);
        }
        catch(InvocationTargetException e)
        {
            Throwable t = e.getCause();
    ...
    private static synchronized byte[] compileClass(String className, Class superClass, Method[] mthd) throws ClassFormatError
    {
